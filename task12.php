            ...
            <div class="col-sm-12 text-center table-responsive">
                <div class="text-left">
                    ...
                    if (isset($_GET['del_id'])) {
                        $sql = mysqli_query($link, "DELETE FROM `products` WHERE `id_product` = :productId");
                        $sql->bind(':productId', $GET['product_id']);
                    ...
                    if (isset($_POST["name"])) {
                        ...
                        if (isset($_GET['red_id'])) {
                            $sql = mysqlQuery("UPDATE `products` SET `name_product` = '{$_POST['name']}',`price` = '{$_POST['price']}',`amount` = '{$_POST['amount']}',`provider_country` = '{$_POST['providerCountry']}',`date_of_delivery` = '{$_POST['date']}' WHERE `id_product`={$_GET['red_id']}");
                        } else {
                            $sql = mysqlQuery("INSERT INTO `products` (`name_product`,`price`,`amount`,`provider_country`,`date_of_delivery`) VALUES ('{$_POST['name']}','{$_POST['price']}','{$_POST['amount']}','{$_POST['providerCountry']}','{$_POST['date']}')");
                        }
                    ...
                    if (isset($_GET['red_id'])) {
                    $sql = mysqlQuery("SELECT `id_product`,`name_product`, `price`,`amount`,`provider_country`,`date_of_delivery` FROM `products` WHERE `id_product`={$_GET['red_id']}");
