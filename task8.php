                    ...
                    <fieldset>
                        ...
                        <div class="form-check-inline">
                            <label class="form-check-label" for="woman">
                                <input type="radio" class="form-check-input" value="<?= $typeWoman ?>" name="gender" id="women">Женский
                            </label>
                        </div>
                        <div class="form-check-inline">
                            <label class="form-check-label" for="man">
                                <input type="radio" class="form-check-input" value="<?= $typeMan ?>" name="gender" id="man" checked>Мужской
                            </label>
                        </div>
                        <br><br>
