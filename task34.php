...
<section class="services" id="blog">
    <div class="container">
        ...
        <div class="row left justify-content-between">
            ...
            <div class="col-xl-6 col-md-6">
                <div class="blog">
                    ...
                    <div><span><i class="far fa-calendar-alt"></i> 14.07.2017</span>
                        <span><i class="far fa-file"></i>Development</span>
                    </div>
                    <p>Raskus prodaction company present this Site and thank you for visit this product.</p>
                </div>
            </div>
        </div>
        <div class="row right justify-content-between">
            <div class="col-xl-6 col-md-6">
                <img src="img/foto2.jpg" alt="" class="img-fluid">
            </div>
            <div class="col-xl-6 col-md-6">
                <div class="blog">
                    <a href="">SEO Quis Vestibulum</a>
        ...
        <div class="row left justify-content-between">
            <div class="col-xl-6 col-md-6">
                <img src="img/foto3.jpg" alt="" class="img-fluid">
            </div>
            <div class="col-xl-6 col-md-6">
                <div class="blog">
                    <a href="">SEO Quis Vestibulum</a>
        ...
        <div class="row">
            <div class="col-xl-12">
                <button class="button_blog">View all</button>
            </div>
        </div>
    </div>
</section>
